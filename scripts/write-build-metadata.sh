...
export BUILD_RUSTC_VERSION="$(rustc +"${HOST_RUST_VERSION}" --version 2>/dev/null || rustc --version 2>/dev/null || true)"
export BUILD_CARGO_VERSION="$(cargo +"${HOST_RUST_VERSION}" --version 2>/dev/null || cargo --version 2>/dev/null || true)"
